"""Compliance Agent Tools - bundled for Foundry Hosted Agent container."""

import sqlite3
from pathlib import Path

# Database is bundled alongside this file in the container image.
...
Actividad Bancaria:
- Numero de Cuentas: {num_accounts}
